# <img src="../icons/android.svg" width="42" align="bottom"> Android 16 — Настройки конфиденциальности
...
- Персонализация рекламы в поиске: **Выкл**  
- Другие настройки → Discover: **Выкл**  
- Настройки автозаполнения → Автозаполнение с трендовыми запросами: **Выкл**
